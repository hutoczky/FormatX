  ...
  try{
    for(const [seconds,name] of SHOTS){
      ...
      const state=await page.evaluate(()=>({
        renderer:document.documentElement.dataset.fxMagBirthRendererR666||document.documentElement.dataset.fxMagBirthRendererR665||document.documentElement.dataset.fxMagBirthRendererR664||'',
