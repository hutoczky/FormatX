...
for(const token of [
  'formatx-signature-system-r185.css?v=20260816-iconic-mag-r185',
  'formatx-signature-system-r185.js?v=20260816-iconic-mag-r185'
...
for(const token of [
  '.fx-signature-core-trigger','.fx-signature-architecture','.fx-signature-map','.fx-signature-node',
...
for(const token of [
  "r185-iconic-mag-architecture-unfold","{id:'hero'","{id:'experience'","{id:'capabilities'","{id:'pricing'","{id:'system'","{id:'resources'",
  "aria-modal","aria-expanded","formatx:signatureunfold","Escape","focusables()","scrollIntoView","ResizeObserver",
  "fxSignatureUsability='touch-focus-reduced-motion-r185'","source:'signature-unfold-r185'"
...
for(const token of [
  ...
  'SYSTEM / NOMINAL','SYSTEM / ACTIVE','MainTabView','0{i + 1}'
...
console.log('PASS: r185 iconic MAG identity, one architecture-unfold moment, usability guards and app system MAG contract are present.');
