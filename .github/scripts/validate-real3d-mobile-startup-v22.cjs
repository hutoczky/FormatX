...
assert.match(layout,/formatx-mobile-reference-layout-v1\.css/);assert.match(layout,/formatx-flow-first-r74\.css\?v=20260814-mag-first-flow-r74/);assert.match(layout,/mag-first-normal-flow-r74/);assert.match(layout,/setPaused/);assert.match(layout,/syncMenuState/);assert.match(layout,/aria-pressed/);assert.match(layout,/pointerup/);assert.match(layout,/space\.after\(rail\)/);assert.doesNotMatch(layout,/desktop-skip/);assert.match(layout,/mobileViewport=.*max-width:900px/);assert.match(layout,/restoreDesktopMenu/);assert.match(layout,/fx-organism-system-toggle/);
assert.match(css,/\.fx-reference-heading/);assert.match(css,/\.fx-reference-proof/);assert.match(css,/\.fx-genome-launcher/);
assert.match(flowCss,/\.topbar\{/);assert.match(flowCss,/position:relative!important/);assert.doesNotMatch(flowCss,/position:sticky!important/);assert.match(flowCss,/#hero \.hero-space/);assert.match(flowCss,/order:0!important/);assert.match(flowCss,/#hero \.fx-reference-rail/);assert.match(flowCss,/order:1!important/);assert.match(flowCss,/#hero \.hero-copy/);assert.match(flowCss,/order:2!important/);assert.match(flowCss,/#hero \.fx-reference-heading/);assert.match(flowCss,/order:3!important/);assert.match(flowCss,/#hero \.fx-reference-proof/);assert.match(flowCss,/order:4!important/);assert.match(flowCss,/#hero \.fx-reference-liveos/);assert.match(flowCss,/#fx-reference-legacy-menu/);
...
console.log('PASS: responsive native WebGL2 v69 r84 mobile startup and desktop-menu hardening contract passed.');