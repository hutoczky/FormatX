...
assert.match(layout,/formatx-mobile-reference-layout-v1\.css/);assert.match(layout,/formatx-flow-first-r74\.css\?v=20260814-mag-first-flow-r74/);assert.match(layout,/mag-first-normal-flow-r74/);assert.match(layout,/setPaused/);assert.match(layout,/syncMenuState/);assert.match(layout,/aria-pressed/);assert.match(layout,/pointerup/);assert.match(layout,/space\.after\(rail\)/);assert.doesNotMatch(layout,/desktop-skip/);assert.match(layout,/const mobile=innerWidth<=900/);assert.match(layout,/restoreDesktopMenu/);
