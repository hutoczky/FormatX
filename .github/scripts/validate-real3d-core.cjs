...
assert.match(layout, /booting-r74/);
...
assert.match(flow, /const mobile=innerWidth<=900/);
...
console.log('PASS: production MAG uses one adaptive native WebGL2 v69 r81 renderer with mobile-only award chrome and restored desktop controls.');