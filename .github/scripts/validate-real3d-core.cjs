...
assert.match(production, /Math\.pow\(Math\.abs\(Math\.cos\(theta \* 2\)\), 9\.5\)/);
...
console.log('PASS: production MAG v51 uses one native WebGL2 reference-crystal renderer with sharp four-tip geometry, faceted glass, moving white nucleus, concentric spectral rings and bounded desktop/mobile framing.');
