...
const mobileProduction = read('docs/scifi-ui/scripts/formatx-core-mobile-award-v56.js');
...
assert.match(productionBootstrap, /formatx-core-mobile-v55\.js\?v=20260812-award-crystal-r1/);
...
assert.match(mobileProduction, /award-four-point-concave-crystal-v56/);
assert.match(mobileProduction, /quadratic-bezier-cusped-outline-v56/);
assert.match(mobileProduction, /bright-faceted-fresnel-glass-v56/);
assert.match(mobileProduction, /white-reactor-nucleus-concentric-cyan-violet-rings-v56/);
...
console.log('PASS: desktop v53 reference and mobile v56 award crystal are production authorities by mode; WebGPU v29 and WebGL2 v28 remain explicit preview paths.');
