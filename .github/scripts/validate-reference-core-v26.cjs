...
assert.match(bootstrap,/formatx-flow-first-r75\.js\?v=20260814-no-overlap-r75/);
...
assert.match(flow,/mag-first-normal-flow-r75/);
...
for(const source of [selector,bootstrap,wrapper,renderer,flow]) new Function(source);
console.log('PASS: responsive cinematic native WebGL2 v69 with r75 no-overlap flow is production authority.');
