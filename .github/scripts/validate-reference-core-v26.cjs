...
assert.match(mobileWrapper, /formatx-core-reference-cinematic-v1\.js\?v=20260812-four-point-reference-r1/);
...
assert.match(production, /reference-four-point-crystal-v1/);
...
console.log('PASS: shared four-point WebGL2 crystal is production authority behind v53/v55 wrappers; WebGPU v29 and WebGL2 v28 remain explicit preview paths.');
