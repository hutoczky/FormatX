...
function apply(){
 ...
 if(mobile){
  ...
  if(heading instanceof HTMLElement){normal(heading);imp(heading,'display','flex');imp(heading,'visibility','visible');imp(heading,'opacity','1');imp(heading,'pointer-events','none');imp(heading,'order','2');imp(heading,'align-self','stretch');imp(heading,'margin','-24px 6% 24px');imp(heading,'z-index','21');}
  ...
  root.dataset.fxReferenceComposition='award-reference-overlay-r138';root.dataset.fxFlowFirstR75='ready-r138';return true;
 }
 ...
 root.dataset.fxReferenceComposition='desktop-native-content-r138';root.dataset.fxFlowFirstR75='ready-r138';return true;
}
