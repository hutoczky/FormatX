/* FormatX R530 — persistent Mini MAG site controller on layouts with a safe
...
const COPY={
  hu:{launcher:'Mini MAG vezérlő megnyitása',title:'MINI MAG',subtitle:'Állandó oldalvezérlő · a nagy MAG megmarad',close:'Bezárás',controls:'VEZÉRLÉS',navigation:'NAVIGÁCIÓ',ask:['ASSZISZTENS','Kérdezz'],menu:['OLDAL','Menü'],sound:['HANG','Hang ki / be'],language:['NYELV','HU / EN'],shape:['MAG','Alakváltás'],hero:['01','Kezdőlap'],experience:['02','Munkafolyamat'],capabilities:['03','Képességek'],pricing:['04','Csomagok'],system:['05','Rendszer'],resources:['06','Letöltések'],foot:'Alt+M: Mini MAG · Esc: panel bezárása'},
  en:{launcher:'Open Mini CORE controller',title:'MINI CORE',subtitle:'Persistent site controller · full CORE remains',close:'Close',controls:'CONTROLS',navigation:'NAVIGATION',ask:['ASSISTANT','Ask'],menu:['SITE','Menu'],sound:['SOUND','Sound on / off'],language:['LANGUAGE','HU / EN'],shape:['CORE','Change shape'],hero:['01','Home'],experience:['02','Workflow'],capabilities:['03','Capabilities'],pricing:['04','Plans'],system:['05','System'],resources:['06','Downloads'],foot:'Alt+M: Mini CORE · Esc: close panel'}
};
