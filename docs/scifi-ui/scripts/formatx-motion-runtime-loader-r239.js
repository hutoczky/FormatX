...
const CURRENT_MAG='/scifi-ui/scripts/formatx-current-mag-loader-r422.js?v=20260922-r1559b-photographic-obsidian-facet-contrast-r1565-native-stage-isolated-canonical-saturation';
const CURRENT_SOLID_GLASS='/scifi-ui/scripts/formatx-mobile-solid-glass-r456.js?v=20260831-r484-native-surface-filaments';
const CURRENT_RENDERER='/scifi-ui/scripts/formatx-crystal-organism-r326.js?v=20260922-r1559b-photographic-obsidian-facet-contrast-r1565-native-stage-isolated-canonical-saturation';
...
const MAG_SHAPE_SYNC='/scifi-ui/scripts/formatx-mag-shape-sync-r476.js?v=20260921-r1520-visible-irregular-mineral';
