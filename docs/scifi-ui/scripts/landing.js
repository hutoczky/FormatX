(function () {
  ...
  const COPY = {
    hu: {
      ...
      heroEyebrow: 'A 2041-ES ADAT- ÉS RENDSZERKEZELÉS SZABVÁNYA', heroTagline: 'Rendszerez. Átalakít. Magasabb szintre emel.', heroDescription: 'Fejlett technikusi platform formázáshoz, diagnosztikához és rendszer-előkészítéshez. A jelenlegi asztali prototípus Windows alatt működik; a natív Linux/Bazzite kiadás fejlesztés alatt áll.', startTrial: '5 napos próba indítása', androidApp: 'Android alkalmazás', exploreFeatures: 'Funkciók felfedezése', assuranceAi: 'Intelligens automatizálás', assuranceSpeed: 'Gyors technikusi motor', assuranceSecurity: 'Többrétegű biztonság',
    ...
    en: {
      ...
      heroEyebrow: 'THE 2041 STANDARD FOR SYSTEM EXCELLENCE', heroTagline: 'Structure. Transform. Elevate.', heroDescription: 'An advanced all-in-one technician platform for formatting, system diagnostics, deployment and cross-platform workflows.', startTrial: 'Start 5-day Trial', androidApp: 'Android App', exploreFeatures: 'Explore Features', assuranceAi: 'Intelligent Automation', assuranceSpeed: 'High-Speed Technician Engine', assuranceSecurity: 'Multi-Layer Security',
