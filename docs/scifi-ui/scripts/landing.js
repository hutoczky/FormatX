(function () {
  ...
  const COPY = {
    hu: {
      ...
      heroEyebrow: 'A JÖVŐ TECHNIKUSI MUNKAFOLYAMATA', heroTagline: 'Rendszerez. Ellenőriz. Biztonságosan végrehajt.', heroDescription: 'A FormatX többplatformos technikusi rendszer meghajtókezeléshez, rendszerdiagnosztikához és rendszer-előkészítéshez. A próbaverzió Linux/Bazzite, Windows és macOS rendszeren is használható.', startTrial: 'Próbaverzió letöltése', androidApp: 'Android-alkalmazás', exploreFeatures: 'Funkciók megtekintése', assuranceAi: 'AI-alapú segítség', assuranceSpeed: 'Átlátható munkafolyamat', assuranceSecurity: 'Többrétegű védelem', platformNow: 'Többplatformos próbaverzió elérhető', platformLinux: 'Linux/Bazzite az elsődleges platform', platformMac: 'Windows és macOS támogatott',
    ...
    en: {
      ...
      heroEyebrow: 'THE NEXT GENERATION OF TECHNICIAN WORKFLOWS', heroTagline: 'Organise. Verify. Execute safely.', heroDescription: 'FormatX is a cross-platform technician system for drive management, system diagnostics and system preparation. The trial version is available for Linux/Bazzite, Windows and macOS.', startTrial: 'Download trial version', androidApp: 'Android app', exploreFeatures: 'Explore Features', assuranceAi: 'AI-assisted guidance', assuranceSpeed: 'Clear technician workflow', assuranceSecurity: 'Multi-layer protection', platformNow: 'Cross-platform trial available', platformLinux: 'Linux/Bazzite is the primary platform', platformMac: 'Windows and macOS supported',
      ...
      featuresTitle: 'PRACTICAL FEATURES. CLEAR WORKFLOWS.', feature1Title: 'Drive management toolkit', feature1Copy: 'Verifiable drive and file operations in the cross-platform trial version.', feature2Title: 'System Diagnostics', feature2Copy: 'Real CPU, memory, network and storage data.', feature3Title: 'Workflow Automation', feature3Copy: 'Deployment, validation and updates in one workflow.', feature4Title: 'Multi-layer protection', feature4Copy: 'Confirmation, audit logs, SHA-256 checks and Ed25519 verification.', feature5Title: 'Real-Time Overview', feature5Copy: 'Measurable system states without fabricated data.', feature6Title: 'Platform status', feature6Copy: 'The trial version is available for Linux/Bazzite, Windows and macOS. Linux/Bazzite is the primary supported platform.',
