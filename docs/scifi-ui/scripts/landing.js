(function () {
  ...
  const COPY = {
    hu: {
      ...
      heroEyebrow: 'A 2041-ES ADAT- ÉS RENDSZERKEZELÉS SZABVÁNYA', heroTagline: 'Rendszerez. Átalakít. Magasabb szintre emel.', heroDescription: 'Fejlett, egységes technikusi platform formázáshoz, rendszerdiagnosztikához, telepítéshez és cross-platform munkafolyamatokhoz.', startTrial: '5 napos próba indítása', androidApp: 'Android alkalmazás', exploreFeatures: 'Funkciók felfedezése', assuranceAi: 'Intelligens automatizálás', assuranceSpeed: 'Gyors technikusi motor', assuranceSecurity: 'Többrétegű biztonság',
