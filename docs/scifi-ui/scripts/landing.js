(function () {
  ...
  const COPY = {
    hu: {
      ...
      heroEyebrow: 'A JÖVŐ TECHNIKUSI MUNKAFOLYAMATA', heroTagline: 'Rendszerez. Ellenőriz. Biztonságosan végrehajt.', heroDescription: 'A FormatX teljes értékű, többplatformos technikusi rendszer meghajtókezeléshez, rendszerdiagnosztikához és rendszer-előkészítéshez. Az első aktiváláskor 5 napos licencet kap; ezt követően az érvényes licenc feltételei szerint működik tovább.', startTrial: 'Teljes verzió letöltése', androidApp: 'Android-alkalmazás', exploreFeatures: 'Funkciók megtekintése', assuranceAi: 'AI-alapú segítség', assuranceSpeed: 'Átlátható munkafolyamat', assuranceSecurity: 'Többrétegű védelem', platformNow: 'Teljes értékű kiadás · 5 napos kezdőlicenc', platformLinux: 'Linux/Bazzite az elsődleges platform', platformMac: 'Windows és macOS támogatott',
      ...
      pricingTitle: 'VÁLASZD KI A MUNKÁDHOZ ILLŐ LICENCCSOMAGOT', planLite: 'Business Lite', planLiteCopy: 'Egyéni technikusoknak és kisebb feladatokra', planPro: 'Business Pro', planProCopy: 'Növekvő technikusi és üzleti környezethez', planTeam: 'Technician Team', planTeamCopy: 'Nagyobb csapatok és több rendszer kezeléséhez', perMonth: '/ hónap', lite1: '1 technikus', lite2: 'Legfeljebb 10 gép', lite3: 'Minden alapfunkció', lite4: 'Alapszintű támogatás', pro1: '3 technikus', pro2: 'Legfeljebb 50 gép', pro3: 'Haladó automatizálás', pro4: 'Elsőbbségi támogatás', team1: '5 technikus', team2: 'Legfeljebb 150 gép', team3: 'Teljes modulkészlet', team4: 'Kiemelt támogatás', choosePlan: 'Csomag kiválasztása', mostPopular: 'LEGNÉPSZERŰBB', trialNote: '5 napos teljes értékű kezdőlicenc', noCard: 'Nincs bankkártya-adatkezelés', cancelAnytime: 'Nincs automatikus megújítás',
      checkoutPreview: 'BIZTONSÁGOS FIZETÉSI FOLYAMAT', selectedPlan: 'Business Pro-licenc', monthlyAccess: '1 hónapos hozzáférés', amountEur: 'Összeg EUR-ban', amountHuf: 'Összeg HUF-ban', fixedAmount: 'Előre rögzített összeg', openCheckout: 'Fizetés megnyitása', scanToPay: 'FIZETÉS QR-KÓDDAL', secureQr: 'Biztonságos banki átutalás', instantSecure: 'Rögzített összeg · HUF vagy EUR · Kézi ellenőrzés',
      featuresTitle: 'HATÉKONY FUNKCIÓK. ÁTLÁTHATÓ MUNKAFOLYAMATOK.', feature1Title: 'Meghajtókezelő eszköztár', feature1Copy: 'Ellenőrizhető meghajtó- és fájlműveletek a teljes értékű, licencalapú kiadásban.', feature2Title: 'Rendszerdiagnosztika', feature2Copy: 'Valós CPU-, memória-, hálózati és tárhelyadatok.', feature3Title: 'Munkafolyamat-automatizálás', feature3Copy: 'Telepítés, ellenőrzés és frissítés egységes folyamatban.', feature4Title: 'Többrétegű védelem', feature4Copy: 'Megerősítés, naplózás, valamint SHA-256- és Ed25519-ellenőrzés.', feature5Title: 'Valós idejű áttekintés', feature5Copy: 'Mérhető rendszerállapotok kitalált adatok nélkül.', feature6Title: 'Platformállapot', feature6Copy: 'A teljes értékű kiadás Linux/Bazzite, Windows és macOS rendszeren is használható. Az 5 napos kezdőlicenc után az érvényes licenc feltételei szerint működik tovább; a Linux/Bazzite az elsődlegesen támogatott platform.',
      trustedTitle: 'ELLENŐRIZHETŐ TECHNOLÓGIAI ALAPOK', trust1Title: 'Ellenőrzött kiadás', trust1Copy: 'GitHub-kiadások és ellenőrzőösszegek', trust2Title: 'Közvetlen támogatás', trust2Copy: 'Nyilvános hibajegy és licenctámogatás', trust3Title: 'Adatvédelem', trust3Copy: 'Nincs bankkártyaadat-kezelés', releaseChannel: 'ELLENŐRZÖTT KIADÁSI CSATORNA', releaseDetails: 'Kiadási részletek →',
      footerCopy: 'Technikusi platform formázáshoz, rendszerdiagnosztikához, telepítéshez és ellenőrzött karbantartási feladatokhoz.', footerProduct: 'TERMÉK', overview: 'Áttekintés', whatsNew: 'Funkciók', integrations: 'Integrációk', roadmap: 'Csomagok', footerResources: 'FORRÁSOK', documentation: 'Támogatás', guides: 'Hibajegyek', community: 'Kiadások', footerLegal: 'JOGI', privacy: 'Adatvédelem', terms: 'Felhasználási feltételek', security: 'Biztonság', checkout: 'Checkout', stayUpdated: 'NAPRAKÉSZ INFORMÁCIÓK', updatesCopy: 'A legújabb elérhető kiadás és a projekt állapota a GitHub kiadási csatornáján követhető.', followReleases: 'Kiadások követése →', backTop: 'Vissza a tetejére ↑'
    },
    en: {
      ...
      heroEyebrow: 'THE NEXT GENERATION OF TECHNICIAN WORKFLOWS', heroTagline: 'Organise. Verify. Execute safely.', heroDescription: 'FormatX is a full-featured cross-platform technician system for drive management, system diagnostics and system preparation. First activation includes a 5-day licence; after that, it continues to operate under the terms of a valid licence.', startTrial: 'Download full version', androidApp: 'Android app', exploreFeatures: 'Explore Features', assuranceAi: 'AI-assisted guidance', assuranceSpeed: 'Clear technician workflow', assuranceSecurity: 'Multi-layer protection', platformNow: 'Full-featured release · 5-day initial licence', platformLinux: 'Linux/Bazzite is the primary platform', platformMac: 'Windows and macOS supported',
      ...
      pricingTitle: 'CHOOSE THE LICENCE PLAN THAT FITS YOUR WORKFLOW', planLite: 'Business Lite', planLiteCopy: 'For individual technicians and smaller workloads', planPro: 'Business Pro', planProCopy: 'For growing technician and business environments', planTeam: 'Technician Team', planTeamCopy: 'For larger teams managing more systems', perMonth: '/ month', lite1: '1 technician', lite2: 'Up to 10 devices', lite3: 'All standard features', lite4: 'Standard support', pro1: '3 technicians', pro2: 'Up to 50 devices', pro3: 'Advanced automation', pro4: 'Priority support', team1: '5 technicians', team2: 'Up to 150 devices', team3: 'Complete module set', team4: 'Priority team support', choosePlan: 'Choose plan', mostPopular: 'MOST POPULAR', trialNote: '5-day full-featured initial licence', noCard: 'No card data processed', cancelAnytime: 'No automatic renewal',
      checkoutPreview: 'SECURE PAYMENT PROCESS', selectedPlan: 'Business Pro Licence', monthlyAccess: '1 month access', amountEur: 'Amount in EUR', amountHuf: 'Amount in HUF', fixedAmount: 'Fixed, predefined amount', openCheckout: 'Open payment page', scanToPay: 'PAY BY QR CODE', secureQr: 'Secure bank transfer', instantSecure: 'Fixed amount · HUF / EUR · Manual verification',
      featuresTitle: 'PRACTICAL FEATURES. CLEAR WORKFLOWS.', feature1Title: 'Drive management toolkit', feature1Copy: 'Verifiable drive and file operations in the full-featured, licence-based release.', feature2Title: 'System Diagnostics', feature2Copy: 'Real CPU, memory, network and storage data.', feature3Title: 'Workflow Automation', feature3Copy: 'Deployment, validation and updates in one workflow.', feature4Title: 'Multi-layer protection', feature4Copy: 'Confirmation, audit logs, SHA-256 checks and Ed25519 verification.', feature5Title: 'Real-Time Overview', feature5Copy: 'Measurable system states without fabricated data.', feature6Title: 'Platform status', feature6Copy: 'The full-featured release is available for Linux/Bazzite, Windows and macOS. After the 5-day initial licence, it continues under the terms of a valid licence; Linux/Bazzite is the primary supported platform.',
