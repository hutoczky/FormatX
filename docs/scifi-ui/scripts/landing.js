(function () {
  ...
  const COPY = {
    hu: {
      ...
      heroEyebrow: 'A 2041-ES ADAT- ÉS RENDSZERKEZELÉS SZABVÁNYA', heroTagline: 'Rendszerez. Átalakít. Magasabb szintre emel.', heroDescription: 'A FormatX meghajtókezeléshez, diagnosztikához és rendszer-előkészítéshez készül. Jelenleg a Windowsos asztali prototípus tölthető le. A natív Linux/Bazzite változat fejlesztés alatt áll, a macOS-verzió pedig későbbi terv.', startTrial: 'Windows próba letöltése', androidApp: 'Android alkalmazás', exploreFeatures: 'Funkciók felfedezése', assuranceAi: 'Intelligens automatizálás', assuranceSpeed: 'Gyors technikusi motor', assuranceSecurity: 'Többrétegű biztonság', platformNow: 'Windows prototípus elérhető', platformLinux: 'Linux / Bazzite fejlesztés alatt', platformMac: 'macOS később tervezett',
    ...
    en: {
      ...
      heroEyebrow: 'THE 2041 STANDARD FOR SYSTEM EXCELLENCE', heroTagline: 'Structure. Transform. Elevate.', heroDescription: 'FormatX is being built for drive management, diagnostics and system preparation. The current downloadable desktop prototype runs on Windows. The native Linux/Bazzite version is under development, while macOS is planned for a later phase.', startTrial: 'Download Windows trial', androidApp: 'Android App', exploreFeatures: 'Explore Features', assuranceAi: 'Intelligent Automation', assuranceSpeed: 'High-Speed Technician Engine', assuranceSecurity: 'Multi-Layer Security', platformNow: 'Windows prototype available', platformLinux: 'Linux / Bazzite in development', platformMac: 'macOS planned later',
      ...
      footerCopy: 'A technician platform for formatting, system diagnostics, deployment and secure maintenance operations.', footerProduct: 'PRODUCT', overview: 'Overview', whatsNew: 'Features', integrations: 'Integrations', roadmap: 'Plans', footerResources: 'RESOURCES', documentation: 'Support', guides: 'Issues', community: 'Releases', footerLegal: 'LEGAL', privacy: 'Privacy', terms: 'Terms of Use', security: 'Security', checkout: 'Checkout', stayUpdated: 'STAY UPDATED', updatesCopy: 'Follow the latest stable release and project status through the GitHub release channel.', followReleases: 'Follow Releases →', backTop: 'Back to top ↑'
    }
  };
