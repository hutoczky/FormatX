(function () {
  ...
  root.dataset.fxCoreMobileAwardRevision = 'reference-spectral-coarse-faceted-native-webgl-v69-r119-interactive';
  ...
  loadReferenceLayout();
  const renderer=document.createElement('script');renderer.src='/scifi-ui/scripts/formatx-core-mobile-reference-r99.js?v=20260814-luminous-cinematic-r99&rev=20260815-spectral-coarse-r119';renderer.async=false;renderer.dataset.fxCoreMobileReferenceV69='true';renderer.dataset.fxCoreMobileReferenceR99='true';renderer.dataset.fxCoreTrueMeshR112='true';renderer.dataset.fxCoreVividR113='true';renderer.dataset.fxCoreFacetedR114='true';renderer.dataset.fxCoreRefractiveR116='true';renderer.dataset.fxCoreBarycentricR117='true';renderer.dataset.fxCoreFacetedGlassR118='true';renderer.dataset.fxCoreSpectralR119='true';
  renderer.addEventListener('load',()=>{root.dataset.fxCoreReferenceLockLoad='ready-v69-r119';},{once:true});
  renderer.addEventListener('error',()=>{root.dataset.fxCoreMobileV55='load-failed-v55';root.dataset.fxCoreMobileV69='load-failed-v69';root.dataset.fxCoreMobileR99='load-failed-r99';root.dataset.fxCoreReferenceLock='load-failed-v69';root.dataset.fxCoreReal3d='context-unavailable';dispatchEvent(new CustomEvent('formatx:core3dfallback',{detail:{reason:'native-webgl-renderer-load-failed',reference:'v69-r119'}}));},{once:true});
