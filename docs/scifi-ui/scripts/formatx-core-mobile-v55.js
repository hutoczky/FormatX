(function () {
  ...
  root.dataset.fxCoreMobileAwardRevision = 'cinematic-reference-v61-r4';
  ...
  renderer.addEventListener('load', () => {
    ...
    fidelity.src = '/scifi-ui/scripts/formatx-core-mobile-reference-fidelity-v61.js?v=20260812-reference-fidelity-r4';
