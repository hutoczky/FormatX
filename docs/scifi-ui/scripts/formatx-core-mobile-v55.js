(function () {
  ...
  root.dataset.fxCoreMobileAwardRevision = 'pixel-reference-native-webgl2-v62-r1';
  ...
  renderer.src = '/scifi-ui/scripts/formatx-core-mobile-reference-v62.js?v=20260813-pixel-reference-native-r1';
