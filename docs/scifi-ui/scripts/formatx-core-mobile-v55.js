(function () {
  ...
  root.dataset.fxCoreMobileAwardRevision = 'cinematic-reference-v61-r2';
  ...
  function registerFidelity() {
    ...
    if (overlay) {
      overlay.style.setProperty('transform', 'translateY(10.7%) scale(1.09,1.13)', 'important');
  ...
  renderer.src = '/scifi-ui/scripts/formatx-core-mobile-reference-v60.js?v=20260812-cinematic-reference-r5';
  ...
  renderer.addEventListener('load', () => {
    ...
    fidelity.src = '/scifi-ui/scripts/formatx-core-mobile-reference-fidelity-v61.js?v=20260812-reference-fidelity-r2';
