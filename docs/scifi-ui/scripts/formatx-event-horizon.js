...
const PRELOADER_SCRIPT_AT=performance.now();
const PRELOADER_NAV_AT=performance.getEntriesByType('navigation')[0]?.startTime??0;
const PRELOADER_BOOT_AT=!MOBILE&&!REDUCED&&PRELOADER_SCRIPT_AT<PRELOADER_MAX_MS?PRELOADER_NAV_AT:PRELOADER_SCRIPT_AT;
const INTRO_TIMING=window.FormatXIntroTiming={bootAt:PRELOADER_BOOT_AT,scriptAt:PRELOADER_SCRIPT_AT,releaseEligibleAt:PRELOADER_BOOT_AT+PRELOADER_MIN_MS};
...
const preloader=PRELOADER_SCRIPT_AT>=PRELOADER_MAX_MS?skipLatePreloader():showPreloader();
