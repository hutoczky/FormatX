...
let audio=null,preloaderTimer=0,preloaderDeadlineTimer=0,preloaderRevealTimer=0,preloaderPhaseTimerA=0,preloaderPhaseTimerB=0,preloaderWatchdog=0,preloaderReleaseClock=null,preloaderReleased=false,preloaderDeadlineAbort=null,preloaderReleaseAbort=null,introNotifyFrameA=0,introNotifyFrameB=0;
...
function armCompositorReleaseClock(overlay,delay){if(MOBILE||REDUCED||!(overlay instanceof HTMLElement)||typeof overlay.animate!=='function')return;try{preloaderReleaseClock=overlay.animate([{opacity:1},{opacity:1}],{duration:Math.max(1,delay),iterations:1,fill:'none'});preloaderReleaseClock.onfinish=()=>{preloaderReleaseClock=null;requestPreloaderRelease('compositor-release-clock-r840');};ROOT.dataset.fxPreloaderReleaseClockR840='waapi-compositor-1400-fallback-safe';}catch(_){preloaderReleaseClock=null;ROOT.dataset.fxPreloaderReleaseClockR840='waapi-unavailable-fallback';}}
