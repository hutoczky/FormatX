(function () {
  ...
  const TRANSLATIONS = [
    ...
    ['. Az', '. I have read and understood the'],
    ['adatkezelési tájékoztatót', 'privacy notice'],
    ['elolvastam és tudomásul vettem. Tudomásul veszem, hogy ez egyszeri banki átutalás, és a licenc csak a jóváírás kézi ellenőrzése után aktiválódik.', '. I understand that this is a one-time bank transfer and the licence is activated only after manual verification of the credit.'],
