(function () {
  ...
  const OPTICS_STYLE_URL = '/scifi-ui/styles/formatx-mobile-core-optics-r328.css?v=20260824-r340-calmer-flare-gentle-edges';
  ...
  function ensureOpticsStyle() {
    ...
    if (existing instanceof HTMLLinkElement) {
      if (!existing.href.includes('r340-calmer-flare-gentle-edges')) existing.href = OPTICS_STYLE_URL;
      root.dataset.fxCoreMobileOpticsR328 = 'r340-calmer-flare-gentle-edge-owner';
      return;
    }
    const link = document.createElement('link');
    link.rel = 'stylesheet';
