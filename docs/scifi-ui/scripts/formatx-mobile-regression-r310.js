(function () {
  ...
  const OPTICS_STYLE_URL = '/scifi-ui/styles/formatx-mobile-core-optics-r328.css?v=20260826-r353-soft-luminous-glass';
  ...
  function ensureOpticsStyle() {
    ...
    if (existing instanceof HTMLLinkElement) {
      if (!existing.href.includes('r353-soft-luminous-glass')) existing.href = OPTICS_STYLE_URL;
      root.dataset.fxCoreMobileOpticsR328 = 'r353-soft-luminous-glass-owner';
      return;
    }
    const link = document.createElement('link');
    link.rel = 'stylesheet';
