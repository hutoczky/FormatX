(function () {
  ...
  const OPTICS_STYLE_URL = '/scifi-ui/styles/formatx-mobile-core-optics-r328.css?v=20260824-r342-restrained-glow-soft-edge';
  ...
  function ensureOpticsStyle() {
    ...
    if (existing instanceof HTMLLinkElement) {
      if (!existing.href.includes('r342-restrained-glow-soft-edge')) existing.href = OPTICS_STYLE_URL;
      root.dataset.fxCoreMobileOpticsR328 = 'r342-restrained-glow-soft-edge-owner';
      return;
    }
    const link = document.createElement('link');
    link.rel = 'stylesheet';
