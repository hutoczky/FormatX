(function () {
  ...
  const queue = [
    ...
    './scripts/formatx-mobile-unified.js?v=20260925-r1727i-document-offset-loop-geometry-living-habitat',
    './scripts/formatx-infinite-scroll.js?v=20260925-r1727i-document-offset-loop-geometry',
