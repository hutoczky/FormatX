(function () {
  ...
  const queue = [
    ...
    './scripts/formatx-mobile-unified.js?v=20260924-r1727-loop-gesture-stable-living-habitat',
    './scripts/formatx-infinite-scroll.js?v=20260924-r1727-loop-gesture-stable',
