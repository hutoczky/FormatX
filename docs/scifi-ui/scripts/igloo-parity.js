(function () {
  ...
  const queue = [
    ...
    './scripts/formatx-mobile-unified.js?v=20260924-r1723-idle-live-geometry-recovery',
    './scripts/formatx-infinite-scroll.js?v=20260924-r1723-idle-live-geometry-recovery',
