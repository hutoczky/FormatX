(function () {
  ...
  const MOBILE_SCRIPT = '/scifi-ui/scripts/formatx-core-mobile-v55.js?v=20260813-target-calibrated-v66-r1';
  ...
  root.dataset.fxCoreRenderer = mobile ? 'single-webgl2-mobile-cinematic-reference-calibrated-v66' : 'single-webgl2-reference-crystal-v53';
  root.dataset.fxCoreReferenceLock = mobile ? 'loading-v66' : 'loading-v53';
