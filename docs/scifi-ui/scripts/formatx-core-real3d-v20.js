(function () {
  'use strict';
  // r136 bootstrap: supplied reference pixels + native WebGL interaction, no title-band crystal erasure.
  const root = document.documentElement;
  const BOOTSTRAP = 'responsive-cinematic-reference-v69-r99-luminous-interactive-r136';
  ...
  const FINAL_STYLE = '/scifi-ui/styles/formatx-reference-final-r132.css?v=20260815-pixel-lock-r136';
