(function () {
  ...
  const BOOTSTRAP = 'responsive-cinematic-reference-v69-r77-measured-award-lock';
  ...
  const AWARD_STYLE = '/scifi-ui/styles/formatx-award-reference-r76.css?v=20260814-award-reference-r77';
  ...
  root.dataset.fxCoreRenderer = 'single-webgl2-responsive-cinematic-reference-glass-v69-r77';
  ...
  function addMobileStyle(){addStyle(MOBILE_STYLE,'data-fx-core-mobile-v55-style');addStyle(AWARD_STYLE,'data-fx-award-reference-r76','ready-r77');}
