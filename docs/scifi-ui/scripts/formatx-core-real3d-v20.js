(function () {
  ...
  const BOOTSTRAP = 'responsive-cinematic-reference-v69-r80-pixel-aspect-award-lock';
  ...
  root.dataset.fxCoreRenderer = 'single-webgl2-responsive-cinematic-reference-glass-v69-r80';
  ...
  function addMobileStyle(){addStyle(MOBILE_STYLE,'data-fx-core-mobile-v55-style');addStyle(AWARD_STYLE,'data-fx-award-reference-r80','ready-r80');}
