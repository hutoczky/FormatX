(function () {
  'use strict';
  // r111 bootstrap: converging faceted native WebGL + user-approved size + cinematic polish + interaction bridge.
  const root = document.documentElement;
  const BOOTSTRAP = 'responsive-cinematic-reference-v69-r99-luminous-interactive';
  const MOBILE_SCRIPT = '/scifi-ui/scripts/formatx-core-mobile-v55.js?v=20260814-luminous-cinematic-r99&rev=20260814-faceted-crystal-r111';
