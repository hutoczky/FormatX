(function () {
  'use strict';
  // r135 bootstrap: repaired supplied material + locked mobile reference geometry/typography.
  const root = document.documentElement;
  const BOOTSTRAP = 'responsive-cinematic-reference-v69-r99-luminous-interactive-r135';
  ...
  const FINAL_STYLE = '/scifi-ui/styles/formatx-reference-final-r132.css?v=20260815-pixel-lock-r135';
