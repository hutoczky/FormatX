(function () {
  'use strict';
  // r94 luminous crystalline shipment; preserve r87 size and strengthen reference-like ice lattice depth.
  const root = document.documentElement;
  const BOOTSTRAP = 'responsive-cinematic-reference-v69-r94-rayglass';
  const MOBILE_SCRIPT = '/scifi-ui/scripts/formatx-core-mobile-v55.js?v=20260814-rayglass-r94';
  ...
  const RAYGLASS_STYLE = '/scifi-ui/styles/formatx-award-material-r91.css?v=20260814-rayglass-r94';
  ...
  root.dataset.fxCoreReal3d='loading-v69';root.dataset.fxCoreRenderer='single-webgl-refractive-rayglass-r94';root.dataset.fxCoreReferenceLock='loading-v69';
  ...
  function addMobileStyle(){addStyle(MOBILE_STYLE,'data-fx-core-mobile-v55-style');addStyle(AWARD_STYLE,'data-fx-award-reference-r80');addStyle(R87_STYLE,'data-fx-award-reference-r87');addStyle(MATERIAL_STYLE,'data-fx-award-material-r88');addStyle(FACET_STYLE,'data-fx-award-material-r89');addStyle(CLARITY_STYLE,'data-fx-award-material-r90');addStyle(RAYGLASS_STYLE,'data-fx-award-material-r91','fxCoreMaterialR94');addStyle(PROOF_STYLE,'data-fx-award-proof-r85');}
  ...
  function addFlowGuard(){if(document.querySelector('script[data-fx-flow-first-r75]'))return;const s=document.createElement('script');s.src=FLOW_SCRIPT;s.async=false;s.dataset.fxFlowFirstR75='true';s.addEventListener('load',()=>{root.dataset.fxFlowFirstGuard='ready-r94';},{once:true});s.addEventListener('error',()=>{root.dataset.fxFlowFirstGuard='failed-r94';},{once:true});document.head.appendChild(s);}
