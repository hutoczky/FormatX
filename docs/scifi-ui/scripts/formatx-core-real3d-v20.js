(function () {
  ...
  const BOOTSTRAP = 'responsive-cinematic-reference-v69-r79-pixel-measured-award-lock';
  ...
  const AWARD_STYLE = '/scifi-ui/styles/formatx-award-reference-r79.css?v=20260814-pixel-measured-r79';
  ...
  root.dataset.fxCoreRenderer = 'single-webgl2-responsive-cinematic-reference-glass-v69-r79';
  ...
  function addMobileStyle(){addStyle(MOBILE_STYLE,'data-fx-core-mobile-v55-style');addStyle(AWARD_STYLE,'data-fx-award-reference-r79','ready-r79');}
