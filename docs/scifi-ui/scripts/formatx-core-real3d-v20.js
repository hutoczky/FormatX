(function () {
  'use strict';
  // r87 cinematic MAG presentation correction under the stable r83 runtime contract.
  ...
  const CINEMATIC_STYLE = '/scifi-ui/styles/formatx-award-reference-r87.css?v=20260814-live-capture-r87';
  ...
  root.dataset.fxCoreRenderer = 'single-webgl2-responsive-cinematic-reference-glass-v69-r87';
  ...
  function addMobileStyle(){addStyle(MOBILE_STYLE,'data-fx-core-mobile-v55-style');addStyle(AWARD_STYLE,'data-fx-award-reference-r80','ready-r81');addStyle(CINEMATIC_STYLE,'data-fx-award-reference-r87','ready-r87');addStyle(PROOF_STYLE,'data-fx-award-proof-r85');}
  ...
  function addFlowGuard(){if(document.querySelector('script[data-fx-flow-first-r75]'))return;const s=document.createElement('script');s.src=FLOW_SCRIPT;s.async=false;s.dataset.fxFlowFirstR75='true';s.addEventListener('load',()=>{root.dataset.fxFlowFirstGuard='ready-r87';},{once:true});s.addEventListener('error',()=>{root.dataset.fxFlowFirstGuard='failed-r87';},{once:true});document.head.appendChild(s);}
