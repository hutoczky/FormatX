/* FormatX R528 — semantic-first, interaction-deferred content enhancements.
...
(function () {
  ...
  function start() {
    ...
    disarm();
    specs.forEach(mount);
    root.dataset.fxDeferredVisualStylesR300 = 'production-css-owned-r528';
    root.dataset.fxContentRuntimeR241 = 'requested-r528-user-intent';
  }

  root.dataset.fxContentRuntimeR241 = 'armed-r528-user-intent';
  root.dataset.fxDeferredVisualStylesR300 = 'production-css-owned-r528';
  root.dataset.fxFirstFrameStabilityR283 = 'immutable-css-r528';
  root.dataset.fxContentRuntimeContractR528 = 'living-core-controls-no-manual-pause';
