/* FormatX r455/R531/R628/R840 — CSP-safe mobile geometry seed + interaction-gated reduced-motion stylesheet.
   ...
   R840 seeds the desktop intro pending state in the earliest defer bootstrap so
...
function armDesktopIntroPrepaint(){
  ...
  root.dataset.fxIntro='desktop-prepaint-pending-r840';
  root.dataset.fxIntroBootStateR840='earliest-defer-pending';
...
/* deploy-ready-r455-csp-safe-mobile-geometry-r531-overlay-owner-r628-clock-keepalive-r840-desktop-prepaint */
