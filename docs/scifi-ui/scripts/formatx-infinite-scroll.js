(function () {
  ...
  const RUNTIME_SRC = '/scifi-ui/scripts/formatx-infinite-scroll-desktop-v7.js?v=20260924-r1724-end-intent-latch';
  ...
  root.dataset.fxScrollBootstrapRevision = 'r1724-end-intent-latch';
