(function () {
  ...
  const RUNTIME_SRC = '/scifi-ui/scripts/formatx-infinite-scroll-desktop-v7.js?v=20260924-r1724-pending-relative-correction';
  const MOBILE_LOOP_STYLE = '/scifi-ui/styles/formatx-mobile-seamless-loop.css?v=20260812-r1';
  const HEART_CORE_RUNTIME = '/scifi-ui/scripts/formatx-heart-core-r252.js?v=20260924-r1723-delegated-semantic-hit';
  ...
  root.dataset.fxScrollBootstrapRevision = 'r1724-pending-relative-correction';
