(function () {
  ...
  const RUNTIME_SRC = '/scifi-ui/scripts/formatx-infinite-scroll-desktop-v7.js?v=20260923-r1679-scroll-safe-mirror-capture';
  ...
  root.dataset.fxScrollBootstrapRevision = 'r1679-scroll-safe-mirror-capture';
