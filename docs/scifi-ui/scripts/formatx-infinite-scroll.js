(function () {
  ...
  const RUNTIME_SRC = '/scifi-ui/scripts/formatx-infinite-scroll-desktop-v7.js?v=20260924-r1723-reachable-threshold';
  ...
  root.dataset.fxScrollBootstrapRevision = 'r1723-reachable-threshold';
