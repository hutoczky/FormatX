(function () {
  ...
  if (root.dataset.fxAudioToggleR191 === 'ready' || root.dataset.fxAudioToggleR191 === 'mounting') return;
  root.dataset.fxAudioToggleR191 = 'mounting';
  ...
  function mount() {
    ...
    if (document.querySelector('.fx-audio-toggle-r191')) {
      root.dataset.fxAudioToggleR191 = 'ready';
      return;
    }

    const styleHref = '/scifi-ui/styles/formatx-audio-toggle-r191.css?v=20260817-r191b';
