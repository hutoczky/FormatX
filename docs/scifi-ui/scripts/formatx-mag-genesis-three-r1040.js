(() => {
  ...
  class FormatXGenesisThree {
    ...
    updateOrganic(t,time){
      ...
      this.organicVeinMaterial.opacity=.66*visible;
  ...
  async function attach(canvas,getTarget){
    ...
    try{
      ...
      if(!visualProof && isSoftwareWebGL()){
        document.documentElement.dataset.fxMagBirthR1040='software-webgl-r649-fallback';
        return null;
      }
      loader ||= loadThree();
      ...
      return {
        ...
        engine,
        revision:'r1040-surface-vein-network-three-genesis'
      };
    }catch(error){
      console.error('FormatX R1040 genesis renderer failed:',error);
      document.documentElement.dataset.fxMagBirthR1040='fallback-r649';
      return null;
    }
  }
  ...
  window.FormatXMagGenesisThreeR1040={
    attach,
    revision:'r1040-surface-vein-network-three-genesis-dna-cellular-living-architecture'
  };
})();