...
const CONTINUOUS_SCROLL_ASSET = [
  ...
  '  <script defer data-fx-seamless-scroll-runtime="true" src="/scifi-ui/scripts/formatx-infinite-scroll.js?v=20260925-r1727i-document-offset-loop-geometry"></script>',
].join('\n') + '\n';
