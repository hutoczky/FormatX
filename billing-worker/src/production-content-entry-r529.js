...
/* FormatX R627 — direct canonical production ownership + device-relevant first-paint delivery.
   ...
   Only genuinely noncritical enhancements remain deferred. MAG and the extended
   intro keep their normal visitor lifecycle with no audit-only path. */
...
function r543Headers(source,localCandidate){const headers=new Headers(source);headers.set('X-FormatX-Transport-Stability','r627-device-relevant-first-paint-preloads');headers.set('X-FormatX-Edge-Stability','r627-desktop-critical-core-html-media-only');headers.set('X-FormatX-CSS-Scheduler','r627-no-mobile-desktop-core-preload');headers.set('X-FormatX-Product-Contract','r543-navigation-mag-elevated-heart-no-manual-pause');headers.set('X-FormatX-MAG-Startup','r543-navigation-owned-elevated-body-heart');headers.set('X-FormatX-Mobile-LCP','r627-no-desktop-critical-core-preload');headers.set('X-FormatX-Preloader','r543-static-content-extended-roadmap-timing');headers.set('X-FormatX-Preloader-Cache','r543-extended-static-lcp-audio-owner-safe');headers.set('X-FormatX-Reference-Boot','r536-prepaint-layout-selector');headers.set('X-FormatX-Payment-Surface','r553-post-paint-visible-qr');headers.set('X-FormatX-Layout-Stability','r554-static-hero-shell-critical-core-prepaint');if(localCandidate){headers.set('X-FormatX-Candidate-Delivery','r627-exact-production-entry-localhost-8787');headers.set('X-FormatX-Candidate-Canonical-Origin','formatxsuite.com');headers.set('Link','<https://formatxsuite.com/>; rel="canonical"');}return headers;}
