...
const FIRST_PAINT_LINK = '<link rel="stylesheet" fetchpriority="high" media="(max-width: 900px), (pointer: coarse), (max-aspect-ratio: 27/25)" data-fx-mobile-first-paint-r358="true" data-fx-production-first-paint-r370="true" href="/scifi-ui/styles/formatx-mobile-first-paint-r358.css?v=20260921-r1460-no-hero-ring">';
const P0_MOTION_SCHEDULER = '/scifi-ui/scripts/formatx-p0-motion-scheduler-r490.js?v=20260921-r1460-coherent-cut-crystal';
...
const R502_ASSET_REWRITES = new Map([
  ['/scifi-ui/scripts/formatx-p0-motion-scheduler-r490.js', {
    marker: 'scheduler-to-loader-r1460-coherent-cut-crystal',
    rewrites: [[/formatx-motion-runtime-loader-r239\.js\?v=[^"']+/g, 'formatx-motion-runtime-loader-r239.js?v=20260921-r1460-coherent-cut-crystal']],
  }],
  ['/scifi-ui/scripts/formatx-motion-runtime-loader-r239.js', {
    marker: 'loader-to-mag-shape-sync-r1460',
    rewrites: [[/formatx-mag-shape-sync-r476\.js\?v=[^"']+/g, 'formatx-mag-shape-sync-r476.js?v=20260921-r1460-coherent-cut-crystal']],
  }],
...
function cacheBustR502Runtime(html) {
  return String(html || '')
    ...
    .replace(/formatx-mag-shape-sync-r476\.js\?v=[^"']+/g, 'formatx-mag-shape-sync-r476.js?v=20260921-r1460-coherent-cut-crystal')
