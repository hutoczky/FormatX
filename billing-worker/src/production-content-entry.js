...
const REFERENCE_MODE_BOOT_SCRIPT = '<script defer data-fx-reference-mode-boot-r504="true" src="/scifi-ui/scripts/formatx-reference-mode-boot-r334.js?v=20260903-r504-prepaint-reference-mode"></script>';
...
const FIRST_PAINT_LINK = '<link rel="stylesheet" media="(max-width: 900px), (pointer: coarse), (max-aspect-ratio: 27/25)" data-fx-mobile-first-paint-r358="true" data-fx-production-first-paint-r370="true" href="/scifi-ui/styles/formatx-mobile-first-paint-r358.css?v=20260827-r407-static-parity">';
...
function mergeHomepageLinkHeader(existing) {
  ...
  return [...values, P0_FIRST_PAINT_PRELOAD].join(', ');
}
