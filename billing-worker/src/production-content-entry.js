...
const STARTUP_REVISION = '20260924-r1724-guardian-studio-world';
...
const P0_MOTION_SCHEDULER = '/scifi-ui/scripts/formatx-p0-motion-scheduler-r490.js?v=20260924-r1724-guardian-studio-world';
...
const R502_ASSET_REWRITES = new Map([
  ['/scifi-ui/scripts/formatx-p0-motion-scheduler-r490.js', {
    marker: 'scheduler-to-loader-r1724-guardian-studio-world',
    rewrites: [[/formatx-motion-runtime-loader-r239\.js\?v=[^"']+/g, 'formatx-motion-runtime-loader-r239.js?v=20260924-r1724-guardian-studio-world']],
  }],
  ...
  ['/scifi-ui/scripts/living-architecture.js', {
    ...
    rewrites: [[/igloo-parity\.js\?v=[^"']+/g, 'igloo-parity.js?v=20260924-r1724-idle-reflow-recovery']],
  }],
  ['/scifi-ui/scripts/igloo-parity.js', {
    ...
    rewrites: [
      ...
      [/formatx-mobile-unified\.js\?v=[^"']+/g, 'formatx-mobile-unified.js?v=20260924-r1724-idle-reflow-recovery'],
    ],
  }],
]);
