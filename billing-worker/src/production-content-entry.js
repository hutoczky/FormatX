...
const STARTUP_REVISION = '20260924-r1720-ultra-sharp-living-world';
...
const P0_MOTION_SCHEDULER = '/scifi-ui/scripts/formatx-p0-motion-scheduler-r490.js?v=20260924-r1720-ultra-sharp-living-world';
...
const R502_ASSET_REWRITES = new Map([
  ['/scifi-ui/scripts/formatx-p0-motion-scheduler-r490.js', {
    marker: 'scheduler-to-loader-r1720-ultra-sharp-living-world',
    rewrites: [[/formatx-motion-runtime-loader-r239\.js\?v=[^"']+/g, 'formatx-motion-runtime-loader-r239.js?v=20260924-r1720-ultra-sharp-living-world']],
  }],
