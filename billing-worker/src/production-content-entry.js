...
const P0_MOTION_SCHEDULER = '/scifi-ui/scripts/formatx-p0-motion-scheduler-r490.js?v=20260924-r1723-physiology-v2';
...
const R502_ASSET_REWRITES = new Map([
  ['/scifi-ui/scripts/formatx-p0-motion-scheduler-r490.js', {
    ...
    rewrites: [[/formatx-motion-runtime-loader-r239\.js\?v=[^"']+/g, 'formatx-motion-runtime-loader-r239.js?v=20260924-r1723-physiology-v2']],
  }],
  ...
  ['/scifi-ui/scripts/living-architecture.js', {
    ...
    rewrites: [[/igloo-parity\.js\?v=[^"']+/g, 'igloo-parity.js?v=20260924-r1723-idle-live-geometry-recovery']],
  }],
  ['/scifi-ui/scripts/igloo-parity.js', {
    ...
    rewrites: [
      ...
      [/formatx-mobile-unified\.js\?v=[^"']+/g, 'formatx-mobile-unified.js?v=20260924-r1723-idle-live-geometry-recovery'],
    ],
  }],
]);
...
function cacheBustR502Runtime(html) {
  return String(html || '')
    ...
    .replace(/living-architecture\.js\?v=[^"']+/g, 'living-architecture.js?v=20260924-r1723-validation-contract')
